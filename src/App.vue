...
export default {
  ...
  methods: {
    ...
    CreatePlaylist(_type, _descr, _length, _name){
      ...
      } else if(this.own_playlists.filter(e => e.name == _name) > 0 && this.saveUri == false){
...
<template>
  ...
  <div id="mainWrapper" v-else>
    ...
    <div id="userprofile" @click="openProfile()">
      ...
      <button id="logoutBtn" class="clickable" @click="Logout()">Logout</button>
    </div>
    ...
    <div id="interaction" @keydown.esc="FilterOpen = false; AddSelectionOpen = false " tabindex="-1">
      ...
      <div id="interactionWindow" class="unmarkable">
        ...
        <div id="playlistCreator" v-else-if="mode == 'create'">
          ...
          <button @click="CreatePlaylist('short_term','your top Songs from the last 30 Days', 50, 'top 30 days')" class="clickable">top 30 Days</button>
          <button @click="CreatePlaylist('medium_term','your top Songs from the last 6Months', 50, 'top 6 months')" class="clickable">top 6 Months</button>
          <button @click="CreatePlaylist('long_term','your top Songs ever', 50, 'all time favs')" class="clickable">top All time</button><br>
